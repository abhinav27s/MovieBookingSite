...
<p>Enter details of the Show to be Edited</p>   
<form method ="post" action="http://localhost:8089/NiitProject/EditShowList.jsp">
...
<p>Enter Start time of Show<input type ="text" name="stime" /> -->
