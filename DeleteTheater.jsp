...
<h2>Delete Theaters</h2>
<form method="get" action="http://localhost:8089/NiitProject/DeleteTheater">
<p> Select a Site
...
<p>Enter name of Theater to be deleted<input type="text" name="n"></p>
<p><button type="submit"> Submit</button></p>
</form>
<%
String x=(String)request.getAttribute("e");
if(x!=null)
{%><p>Theater Deleted Successfully!</p><% } %>
<% 
